...
if __name__=="__main__":
    ...
    data_folder = ["T6SA_stance.pos","T6SA_stance.neg","T6SA_stance.none"]   
    ...
    cPickle.dump([revs, revs_test, W, W2, word_idx_map, vocab], open("mr.p", "wb"))
